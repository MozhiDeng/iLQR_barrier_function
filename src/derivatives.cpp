  ...
  VecOfMatXd& c_uu)
{
  ...
  std::function<double(VectorXd, VectorXd, VecofVec2d, VecofVec2d, VecofVec2d)> c = [this](VectorXd x_v, 
      VectorXd u_v, 
      VecofVec2d road_reference_line_v,
      VecofVec2d road_left_side_v,
      VecofVec2d road_right_side_v) {return model->cost(x_v,u_v,road_reference_line_v, road_left_side_v, road_right_side_v);};
...
void IPDDP::calculate_cxu(const VecOfVecXd& x, const VecOfVecXd& u, VecOfMatXd& c_xu, int start_T, int end_T) {
  std::function<double(VectorXd, VectorXd, VecofVec2d)> c = [this](VectorXd x_v, 
      VectorXd u_v, 
      VecofVec2d road_reference_line){return model->cost(x_v,u_v,road_reference_line, road_left_side, road_right_side);};
